...
const GoalDisplay = ({ goal }) => {
  return (
    <>
      <section class="m-auto mx-8 my-2 flex flex-col gap-2   bg-amber-100 px-2 pb-4">
        ...
        <span
          className={" w-1/2 m-auto rounded-md border-2 border-solid px-4 text-center  ".concat(
            goal.succeed
